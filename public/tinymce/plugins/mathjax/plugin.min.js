tinymce.PluginManager.add("mathjax", function (editor) {
  ...
  function createMathPopup({ latex, mode, onSubmit, onCancel, anchorEl }) {
    ...
    input.addEventListener("input", function () {
      ...
      this.style.height = Math.min(this.scrollHeight, 200) + "px"; // 200px là maxHeight
    });
  ...
  function insertMath(latex, mode) {
    ...
    const mathSpan =
      ...
      "</span>";
    if (mode === "block") {
      // Chèn block math là div inline-block, không bọc <p>
  ...
  editor.ui.registry.addIcon(
    "mathfx",
    '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="2" y="19" font-size="18" font-family="monospace" fill="#222">f(x)</text></svg>'
  );
